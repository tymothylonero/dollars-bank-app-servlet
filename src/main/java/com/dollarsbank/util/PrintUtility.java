...
public class PrintUtility {
	...
	private static String loggedInModals = "	<!-- Deposit -->\r\n"
			+ "	\r\n"
			+ "	<div class=\"modal fade\" id=\"depositModal\" data-bs-backdrop=\"static\"\r\n"
			+ "		data-bs-keyboard=\"false\" tabindex=\"-1\"\r\n"
			...
			+ "					<div class=\"input-group mb-3\">\r\n"
			+ "	  					<span class=\"input-group-text\">$</span>\r\n"
			+ "	  					<input type=\"number\" class=\"form-control\" aria-label=\"Deposit amount\" id=\"deposit\" name=\"deposit\" min=\"0\" step=\"0.01\" required>\r\n"
			+ "					</div>\r\n"
			+ "					<p>Description:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"text\" aria-label=\"Description\" id=\"description\" name=\"description\">\r\n"
			+ "					<p></p>\r\n"
			+ "				</div>\r\n"
			+ "				\r\n"
			+ "				<div class=\"modal-footer\">\r\n"
			...
			+ "	<!-- Withdraw -->\r\n"
			+ "	\r\n"
			+ "	<div class=\"modal fade\" id=\"withdrawModal\" data-bs-backdrop=\"static\"\r\n"
			+ "		data-bs-keyboard=\"false\" tabindex=\"-1\"\r\n"
			+ "		aria-labelledby=\"depositModalLabel\" aria-hidden=\"true\">\r\n"
			+ "		<div class=\"modal-dialog\">\r\n"
			+ "			<div class=\"modal-content\">\r\n"
			...
			+ "					<div class=\"input-group mb-3\">\r\n"
			+ "	  					<span class=\"input-group-text\">$</span>\r\n"
			+ "	  					<input type=\"number\" class=\"form-control\" aria-label=\"Withdraw amount\" id=\"withdraw\" name=\"withdraw\" min=\"0\" max=\"1000\" step=\"0.01\" required>\r\n"
			+ "					</div>\r\n"
			+ "					<p>Description:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"text\" aria-label=\"Description\" id=\"description\" name=\"description\">\r\n"
			+ "					<p></p>\r\n"
			...
			+ "				<div class=\"modal-header\">\r\n"
			+ "					<h5 class=\"modal-title\" id=\"staticBackdropLabel\">Transfer Funds</h5>\r\n"
			+ "					<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\"\r\n"
			+ "						aria-label=\"Close\"></button></div>\r\n"
			+ "						\r\n"
			+ "				<div class=\"modal-body\">\r\n"
			+ "					<p>Account to transfer to:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"text\" aria-label=\"Account\" id=\"toAccount\" name=\"toAccount\" required>\r\n"
			+ "					<p></p>\r\n"
			+ "					<p>Amount to transfer:</p>\r\n"
			+ "					<div class=\"input-group mb-3\">\r\n"
			+ "	  					<span class=\"input-group-text\">$</span>\r\n"
			+ "	  					<input type=\"number\" class=\"form-control\" aria-label=\"Transfer amount\" id=\"transfer\" name=\"transfer\" min=\"0\" max=\"1000\" step=\"0.01\" required>\r\n"
			+ "					</div>\r\n"
			+ "					<p>Description:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"text\" aria-label=\"Description\" id=\"description\" name=\"description\">\r\n"
			+ "					<p></p>\r\n"
			...
			+ "			<div class=\"modal-content\">\r\n"
			+ "				<div class=\"modal-header\">\r\n"
			+ "					<h5 class=\"modal-title\" id=\"staticBackdropLabel\">Recent Transactions</h5>\r\n"
			+ "					<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"modal\"\r\n"
			+ "						aria-label=\"Close\"></button></div>\r\n"
			+ "						\r\n"
			+ "				<div class=\"modal-body\">\r\n"
			...
			+ "				<div class=\"modal-body\">\r\n"
			+ "					<p>Old password:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"password\" aria-label=\"Old password\" id=\"oldpassword\" name=\"oldpassword\" required>\r\n"
			+ "					<p></p>\r\n"
			+ "					<p>New password:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"password\" aria-label=\"New password\" id=\"newpassword\" name=\"newpassword\" required>\r\n"
			+ "					<p></p>\r\n"
			+ "				</div>\r\n"
			+ "				\r\n"
			+ "				<div class=\"modal-footer\">\r\n"
	...
	private static String homeMenu = "	<div style=\"text-align:center;\">\r\n"
			...
			+ "		<br>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#depositModal\">Deposit</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#withdrawModal\">Withdraw</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#transferModal\">Transfer Funds</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#transactionModal\">Recent Transactions</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-toggle=\"modal\" data-bs-target=\"#accountModal\">Account Information</button></div>\r\n"
			+ "		<br>\r\n"
