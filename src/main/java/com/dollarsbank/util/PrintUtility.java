...
public class PrintUtility {
	...
	private static String loggedOutModals = "	<!-- Login modal -->\r\n"
			...
			+ "	  					<input type=\"number\" class=\"form-control\" aria-label=\"Initial deposit amount\" id=\"deposit\" name=\"deposit\" min=\"0\" step=\"0.01\">\r\n"
			+ "					</div>\r\n"
			+ "				</div>\r\n"
			+ "				<div class=\"modal-footer\">\r\n"
			+ "					<button type=\"button\" class=\"btn btn-secondary\"\r\n"
	...
	private static String homeMenu = "	<div style=\"text-align:center;\">\r\n"
			...
			+ "		<br>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-target=\"#depositModal\">Deposit</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-target=\"#withdrawModal\">Withdraw</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-target=\"#transferModal\">Transfer Funds</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-target=\"#transactionModal\">Recent Transactions</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-target=\"#accountModal\">Account Information</button></div>\r\n"
			+ "		<br>\r\n"
			+ "		<div><button class=\"btn btn-primary\" type=\"button\" data-bs-target=\"#passwordModal\">Change Password</button></div>\r\n"
			+ "	</div>";
