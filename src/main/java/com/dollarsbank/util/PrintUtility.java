...
public class PrintUtility {
	...
	private static String loggedOutNav = "	<div class=\"collapse\" id=\"navbarToggleExternalContent\">\r\n"
			...
			+ "	    <p class=\"text-muted\">Phone: +1 (800) 1234-567</p>\r\n"
	...
	private static String loggedInNav = "";
	
	private static String loggedOutModals = "	<div class=\"modal fade\" id=\"loginModal\" data-bs-backdrop=\"static\"\r\n"
			...
			+ "					<input class=\"form-control me-2\" type=\"search\" aria-label=\"Username\">\r\n"
			+ "					<p></p>\r\n"
			+ "					<p>Password:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"password\" aria-label=\"Password\">\r\n"
			+ "					<p></p>\r\n"
			+ "					<p>Email:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"search\" aria-label=\"Email\">\r\n"
			+ "					<p></p>\r\n"
			+ "					<p>Address:</p>\r\n"
			+ "					<input class=\"form-control me-2\" type=\"search\" aria-label=\"Address\">\r\n"
			+ "					<p></p>\r\n"
			+ "					<p>Amount to deposit initially:</p>\r\n"
			+ "					<div class=\"input-group mb-3\">\r\n"
			+ "	  					<span class=\"input-group-text\">$</span>\r\n"
			+ "	  					<input type=\"text\" class=\"form-control\" aria-label=\"Initial deposit amount\">\r\n"
			+ "					</div>\r\n"
			+ "				</div>\r\n"
			+ "				<div class=\"modal-footer\">\r\n"
			+ "					<button type=\"button\" class=\"btn btn-secondary\"\r\n"
